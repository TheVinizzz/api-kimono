 ...
 */
router.post('/job/start', auth, trackingController.startAutomaticTracking);
 ...
 *         description: Erro interno do servidor
 */
router.post('/job/stop', auth, trackingController.stopAutomaticTracking);
 ...
 *         description: Erro interno do servidor
 */
router.get('/job/status', auth, trackingController.getTrackingJobStatus);
 ...
 *         description: Erro interno do servidor
 */
router.post('/job/process', auth, trackingController.processTrackingUpdates);
 ...
 *         description: Erro interno do servidor
 */
router.post('/order/:orderId/update', auth, trackingController.forceTrackingUpdate);
 ...
 *         description: Erro interno do servidor
 */
router.get('/order/:orderId/history', trackingController.getTrackingHistory);
 ...
 *         description: Erro interno do servidor
 */
router.get('/code/:trackingCode', trackingController.trackCode);
 ...
 *         description: Erro interno do servidor
 */
router.get('/stats', auth, trackingController.getTrackingStats);
