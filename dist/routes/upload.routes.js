...
router.post('/product', upload_controller_1.uploadSingle, upload_controller_1.UploadController.uploadProductImage);
// Upload de imagem de categoria (single)
router.post('/category', upload_controller_1.uploadSingle, upload_controller_1.UploadController.uploadCategoryImage);
// Upload múltiplo de imagens
router.post('/multiple', upload_controller_1.uploadMultiple, upload_controller_1.UploadController.uploadMultipleImages);
// Deletar arquivo
