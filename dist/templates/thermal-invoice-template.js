...
exports.generateThermalInvoicePDF = exports.generateThermalInvoiceCSS = exports.generateThermalInvoiceHTML = void 0;
const generateThermalInvoiceHTML = (data, width = '80mm') => {
...
exports.generateThermalInvoiceHTML = generateThermalInvoiceHTML;
const generateThermalInvoiceCSS = (width = '80mm') => {
    const isNarrow = width === '58mm';
    return `
    @page {
      size: ${width} auto;
...
exports.generateThermalInvoiceCSS = generateThermalInvoiceCSS;
const generateThermalInvoicePDF = (data_1, ...args_1) => __awaiter(void 0, [data_1, ...args_1], void 0, function* (data, width = '80mm') {
    const html = (0, exports.generateThermalInvoiceHTML)(data, width);
    // Aqui você integraria com uma biblioteca como Puppeteer ou jsPDF
    // Para este exemplo, retornamos um buffer simulado
    return Buffer.from(html, 'utf-8');
});
exports.generateThermalInvoicePDF = generateThermalInvoicePDF;
exports.default = {
    generateThermalInvoiceHTML: exports.generateThermalInvoiceHTML,
    generateThermalInvoiceCSS: exports.generateThermalInvoiceCSS,
    generateThermalInvoicePDF: exports.generateThermalInvoicePDF
};
